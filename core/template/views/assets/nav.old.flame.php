<nav class="navbar navbar-expand-md navbar-dark ms-md-2 me-md-2 {{ (isset($float) && $float) ? 'floatbar' : '' }}">
    ...
    <a href="https://flamephp.mrtn.vip/#welcome" target="_blank" class="navbar-brand"><img src="{{url('/framework.svg')}}" width="27px" style="margin-top:-3px;"> {{ $title ?: _env('NAME', 'Flame Core') }}</a>
